...
function videopro_get_custom_bg(){
    ...
    if(isset($custom_background['background-color'])|| isset($custom_background['background-image'])){
        ...
        $custom_css.= ' ';
        if (!isset($custom_background['background-position'])){
			$custom_background['background-position'] = '0% 0%';
		}
        $custom_css.= 	(isset($custom_background['background-image']) && $custom_background['background-image'] != '')
                        ?('url('.$custom_background['background-image'].') ' . $custom_background['background-position'] . ' /' . $custom_background['background-size'] . ' ' . $custom_background['background-repeat'] . ' ' .
                        $custom_background['background-attachment']):'';
    }
            ...
            if($class_li != ''){
                ...
                <div class="login-msg">
                    <div class="login-content">
                        ...
                        <a href="<?php echo wp_login_url(get_permalink());?>" class="login-link button btn btn-default bt-style-1"><?php esc_html_e('Sign In','videopro');?></a>
                    </div>
                </div>
                <?php
            }
