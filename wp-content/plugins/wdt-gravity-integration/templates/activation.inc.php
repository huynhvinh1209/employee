...
<div class="col-sm-6 m-b-30">
    ...
    <div class="wdt-activation-section">
        ...
        <div class="wpdt-plugins-desc">
            <img class="img-responsive" src="<?php echo WDT_ASSETS_PATH; ?>img/addons/gravity-forms-logo.png" alt="">
            <h4> <?php _e('Gravity Forms Integration', 'wpdatatables'); ?></h4>
        </div>
        ...
        <div class="panel-body">
            ...
            <div class="col-sm-10 wdt-purchase-code-gravity p-l-0">
                ...
                <div class="form-group m-b-0">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <button class="btn btn-primary wdt-store-activate-plugin" id="wdt-activate-plugin-gravity">
